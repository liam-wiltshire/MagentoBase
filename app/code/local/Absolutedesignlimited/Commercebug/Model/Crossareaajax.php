...
*/
abstract class Absolutedesignlimited_Commercebug_Model_Crossareaajax
{
    ...
    */    
    ...
    {
        $controllers = array('Absolutedesignlimited_Commercebug_AjaxController','Absolutedesignlimited_Commercebug_AdminajaxController');
        ...
        foreach($controllers as $controller)
        {
            ...
            'Absolutedesignlimited_Commercebug_Model_Crossareaajax','appendAction'), self::$_actionNames);
