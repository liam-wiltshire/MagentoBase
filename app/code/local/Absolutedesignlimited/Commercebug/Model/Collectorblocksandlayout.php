...
*/
class Absolutedesignlimited_Commercebug_Model_Collectorblocksandlayout extends Absolutedesignlimited_Commercebug_Model_Observingcollector
{
    ...
    {		
        ...
        foreach($this->_blocks as $block)
        {
            ...
            if(strpos($class,'Absolutedesignlimited_Commercebug') === 0)
            {
                continue;
            }
