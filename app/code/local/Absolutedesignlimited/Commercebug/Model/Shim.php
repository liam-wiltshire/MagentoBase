...
*/
class Absolutedesignlimited_Commercebug_Model_Shim
{
    ...
    */    
    ...
    protected function _getNamespaceForGroup($group)
    {
        ...
        {
            case 'commercebug':
                $module = 'Absolutedesignlimited_Commercebug';
    ...
    {
        $full_module_name = 'Absolutedesignlimited_Commercebug';
    ...
    static public function getInstance()
    {
        if(!self::$_instance)
        {
            self::$_instance = new Absolutedesignlimited_Commercebug_Model_Shim;
        }
