...
class Commercebug_Packager
{
    ...
    {
        $string = '<?xml version="1.0" encoding="UTF-8"?><config><modules><Absolutedesignlimited_Commercebug><active>true</active><codePool>local</codePool></Absolutedesignlimited_Commercebug></modules></config>';
        $string = str_replace('Absolutedesignlimited_', $this->namespace . '_',$string);
